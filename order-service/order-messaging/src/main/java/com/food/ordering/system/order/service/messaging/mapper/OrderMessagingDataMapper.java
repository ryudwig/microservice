...
public class OrderMessagingDataMapper {
    public T orderCreatedEventToPaymentRequestAvroModel(OrderCreatedEvent orderCreatedEvent){
    ...
    public T orderCancelledEventToPaymentRequestAvroModel(OrderCancelledEvent orderCancelledEvent){
    ...
    public PaymentResponse paymentResponseAvroModelToPaymentResponse(PaymentResponseAvroModel paymentResponseAvroModel){
        return PaymentResponse.builder()
                ...
                .faildureMessages(paymentResponseAvroModel.getFailureMessages())
                .build();
    }
