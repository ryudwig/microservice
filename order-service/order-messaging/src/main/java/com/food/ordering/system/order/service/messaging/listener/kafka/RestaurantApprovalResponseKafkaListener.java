...
import com.food.ordering.system.order.service.domain.ports.message.listener.restaurantapproval.RestaurantApprovalResponseMessageListener;
...
public class RestaurantApprovalResponseKafkaListener implements KafkaConsumer<RestaurantApprovalResponseAvroModel> {
    ...
    private final String FAILURE_MESSAGE_DELIMITER = ",";
    ...
    public void receive(@Payload List<RestaurantApprovalResponseAvroModel> messages,
        ...
        log.info("{} number of restaurant approval response received with key {}, partitions {} and offsets {}",
                messages.size(),
                keys.toString(),
                partitions.toString(),
                offsets.toString()
        ...
        messages.forEach( restaurantApprovalResponseAvroModel -> {
            if (OrderApprovalStatus.APPROVED == restaurantApprovalResponseAvroModel.getOrderApprovalStatus()) {
                ...
                log.info("Processing rejected order for order id: {}, with failure messages: {}",
                        ...
                        String.join(
                                FAILURE_MESSAGE_DELIMITER, restaurantApprovalResponseAvroModel.getFailureMessages()
                        )
                );
