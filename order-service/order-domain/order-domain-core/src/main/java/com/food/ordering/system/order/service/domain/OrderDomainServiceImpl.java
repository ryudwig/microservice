...
public class OrderDomainServiceImpl implements OrderDomainService{
    ...
    public OrderCreatedEvent validateAndInitiateOrder(Order order, Restaurant restaurant) {
        ...
        */
        ...
        return new OrderCreatedEvent(order, ZonedDateTime.now(zoneId));
    }
    @Override
    public OrderPaidEvent payOrder(Order order) {
        order.pay();
        log.info("Order with is: {} is paid", order.getId().getValue());
        return new OrderPaidEvent(order, ZonedDateTime.now(zoneId));
    }
    ...
    public OrderCancelledEvent cancelOrderPayment(Order order, List<String> failureMessages) {
        ...
        return new OrderCancelledEvent(order, ZonedDateTime.now(zoneId));
    }
